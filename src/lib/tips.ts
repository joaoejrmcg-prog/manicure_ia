...
export const TIPS = [
    ...
    "💳 Cartão de crédito é mais prático! Ative a renovação automática e nunca mais se preocupe em pagar sua mensalidade.",
    "📊 Plano Light: 100 comandos de IA por dia. Plano Pro: comandos ilimitados! Faça upgrade no menu 'Planos'.",
    ...
    "🔍 Use os filtros no Financeiro para ver apenas recebimentos em Pix, Dinheiro ou Cartão.",
    ...
    "💡 Toque no sino amarelo no topo da tela para ver todas as dicas disponíveis, uma de cada vez!",
    "📱 Instale o app na tela inicial! No Chrome: Menu → Adicionar à tela inicial. Funciona como app nativo!",
    "🔔 Ative as notificações para receber lembretes de agendamentos e vencimentos de faturas.",
